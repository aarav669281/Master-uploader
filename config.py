...
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7148143814:AAF8ET_NfrSnq6X__Ejxg8BqBZpNbgrbdds")  # Ensure correct key name
    ...
    AUTH_USER = os.environ.get("AUTH_USERS", "6226272085").split(',')
